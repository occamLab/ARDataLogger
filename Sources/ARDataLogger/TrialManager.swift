...
struct ARFrameDataLog {
    ...
    init(timestamp: Double, type: String, jpegData: Data, rawFeaturePoints: [simd_float3]?, projectedFeaturePoints: [CGPoint]?, depthData: [simd_float4], intrinsics: simd_float3x3, planes: [ARPlaneAnchor], pose: simd_float4x4, meshes: [(String, [String: [[Float]]])]?) {
